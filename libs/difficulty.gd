...
func update_difficulty_settings():
	...
	if score < 5000:
		Globals.settings["small_asteroid_range"] = [0, 1]
		Globals.settings["initial_asteroid_impulse_range"] = [150.0, 180.0]
		Globals.settings["asteroid_limit"] = 15
		Globals.settings["asteroid_shield_chance"] = 0.1
		...
		Globals.settings["asteroid_limit"] = 25
		Globals.settings["asteroid_shield_chance"] = 0.2
		Globals.settings["asteroid_spawn_time"] = 0.8
	elif score < 15000:
		...
		Globals.settings["asteroid_spawn_time"] = 0.7
	elif score < 20000:
		...
		Globals.settings["asteroid_spawn_time"] = 0.6
	elif score < 30000:
